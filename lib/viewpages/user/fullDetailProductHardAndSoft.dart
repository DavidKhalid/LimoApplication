...
import 'package:limoapplication/viewpages/user/formNegoisasiHardAndSoftUser.dart';

class FullDetailProductHardAndSoft extends StatefulWidget {
  @override
  State<FullDetailProductHardAndSoft> createState() =>
      _FullDetailProductHardAndSoftState();
}

class _FullDetailProductHardAndSoftState
    extends State<FullDetailProductHardAndSoft> {
  @override
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) {
                      return FormNegoisasiHardwareAndSoftwareUser();
                    },
                  ));
                },
                child: Container(
